...
*Implementation: `train.py` (feature capture), `analyze.py` (derived features & classifiers), `analyze.py` (token-level). Validation data: `results/ratio10/auc_univariate.csv`, `results/ratio10/detection_multivariate.csv`.*

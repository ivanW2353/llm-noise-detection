...
- [8. Appendix: Raw Data and Metric Definitions](#8-appendix-raw-data-and-metric-definitions)
  ...
  - [8.5 Collection timing (measured, `keyword@dolly-ratio10`, single NVIDIA RTX PRO 6000 Blackwell Server Edition — the project's earlier card)](#85-collection-timing-measured-keyworddolly-ratio10-single-nvidia-rtx-pro-6000-blackwell-server-edition--the-projects-earlier-card)

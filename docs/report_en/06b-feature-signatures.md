...
**The deployment decision driven by this finding** (a single feature replacing a mixed scheme) belongs to Thread 3 — see the feature-group ablation experiment in [06c-detectability.md](06c-detectability.md) Sections 6.11.2-6.11.3.

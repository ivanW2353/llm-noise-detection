...
*Definitional foundation for Thread 2 (feature signatures) — `text_nn_sim` is the core feature behind [06b](06b-feature-signatures.md) Section 6.8's "two types' high AUC is misleading" finding.*
...
*Direct evidence for Thread 2 (feature signatures) — real text backing [06b](06b-feature-signatures.md) Section 6.2's detection-difficulty ranking.*
...
*Direct evidence for Thread 2 (feature signatures) — [06b](06b-feature-signatures.md) Section 6.6's raw-curve backing for the direction-reversal trap.*
